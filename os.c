...
const elysian_fs_partition_t fs_partitions[] = {
	...
	},
	{
        ...
        .ftell = elysian_port_fs_disk_ftell,
		.fread = elysian_port_fs_disk_fread,
		.fwrite = elysian_port_fs_disk_fwrite,
		.fclose = elysian_port_fs_disk_fclose,
		.fremove = elysian_port_fs_disk_fremove
	},
	{
